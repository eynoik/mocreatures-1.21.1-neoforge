            ...
            if (entityHorse.getIsTamed() && (entityHorse.getPassengers().isEmpty())) {
                ...
                if (f5 < 256F) {
                    ...
                    if (showHealth) {
                        ...
                        vertexconsumer.addVertex(matrix, -20F + barWidth, -10 + yOff, 0.0F).setColor(0.7F, 0.0F, 0.0F, 1.0F)
                                .setUv(0, 0).setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);
                        vertexconsumer.addVertex(matrix, -20F + barWidth, -6 + yOff, 0.0F).setColor(0.7F, 0.0F, 0.0F, 1.0F)
                                .setUv(0, 1).setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);
                        vertexconsumer.addVertex(matrix, 20F, -6 + yOff, 0.0F).setColor(0.7F, 0.0F, 0.0F, 1.0F).setUv(1, 1)
                                .setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);
                        vertexconsumer.addVertex(matrix, 20F, -10 + yOff, 0.0F).setColor(0.7F, 0.0F, 0.0F, 1.0F).setUv(1, 0)
                                .setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);

                        // Green health (filled health)
                        vertexconsumer = buffer.getBuffer(RenderType.text(WHITE_TEXTURE));
                        vertexconsumer.addVertex(matrix, -20F, -10 + yOff, 0.01F).setColor(0.0F, 0.7F, 0.0F, 1.0F).setUv(0, 0)
                                .setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);
                        vertexconsumer.addVertex(matrix, -20F, -6 + yOff, 0.01F).setColor(0.0F, 0.7F, 0.0F, 1.0F).setUv(0, 1)
                                .setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);
                        vertexconsumer.addVertex(matrix, barWidth - 20F, -6 + yOff, 0.01F).setColor(0.0F, 0.7F, 0.0F, 1.0F)
                                .setUv(1, 1).setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);
                        vertexconsumer.addVertex(matrix, barWidth - 20F, -10 + yOff, 0.01F).setColor(0.0F, 0.7F, 0.0F, 1.0F)
                                .setUv(1, 0).setOverlay(0).setLight(packedLight).setNormal(0, 1, 0);
                    }
