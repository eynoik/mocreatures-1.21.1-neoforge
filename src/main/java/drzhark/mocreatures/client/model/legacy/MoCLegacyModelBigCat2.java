...
public class MoCLegacyModelBigCat2<T extends MoCEntityBigCat> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "legacy_bigcat2"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer,
        ...
        this.ears.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        if (this.tamed) {
            this.collar.render(poseStack, buffer, packedLight, packedOverlay, color);
        }
    }
}
