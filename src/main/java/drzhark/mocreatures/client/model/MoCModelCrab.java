...
public class MoCModelCrab<T extends MoCEntityCrab> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mocreatures", "crab"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer,
        ...
        this.shell_right.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.shell_left.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.shell_back.render(poseStack, buffer, packedLight, packedOverlay, color);

        this.left_eye.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.left_eye_base.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.right_eye_base.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.right_eye.render(poseStack, buffer, packedLight, packedOverlay, color);

        this.right_arm_a.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.left_arm_a.render(poseStack, buffer, packedLight, packedOverlay, color);

        this.left_leg1_a.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.left_leg2_a.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.left_leg3_a.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.left_leg4_a.render(poseStack, buffer, packedLight, packedOverlay, color);

        this.right_leg1_a.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.right_leg2_a.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.right_leg3_a.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.right_leg4_a.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
}
