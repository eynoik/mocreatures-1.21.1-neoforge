...
public abstract class MoCModelAbstractScorpion<T extends net.minecraft.world.entity.Entity> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mocreatures", "scorpion"), "main");
    ...
    public void renderToBuffer(PoseStack stack, VertexConsumer builder, int packedLight, int packedOverlay, int color) {
        this.head.render(stack, builder, packedLight, packedOverlay, color);
        this.mouthL.render(stack, builder, packedLight, packedOverlay, color);
        this.mouthR.render(stack, builder, packedLight, packedOverlay, color);
        this.body.render(stack, builder, packedLight, packedOverlay, color);
        this.tail1.render(stack, builder, packedLight, packedOverlay, color);
        this.tail2.render(stack, builder, packedLight, packedOverlay, color);
        this.tail3.render(stack, builder, packedLight, packedOverlay, color);
        this.tail4.render(stack, builder, packedLight, packedOverlay, color);
        this.tail5.render(stack, builder, packedLight, packedOverlay, color);
        this.sting1.render(stack, builder, packedLight, packedOverlay, color);
        this.sting2.render(stack, builder, packedLight, packedOverlay, color);
        this.lArm1.render(stack, builder, packedLight, packedOverlay, color);
        this.lArm2.render(stack, builder, packedLight, packedOverlay, color);
        this.lArm3.render(stack, builder, packedLight, packedOverlay, color);
        this.lArm4.render(stack, builder, packedLight, packedOverlay, color);
        this.rArm1.render(stack, builder, packedLight, packedOverlay, color);
        this.rArm2.render(stack, builder, packedLight, packedOverlay, color);
        this.rArm3.render(stack, builder, packedLight, packedOverlay, color);
        this.rArm4.render(stack, builder, packedLight, packedOverlay, color);
        this.leg1A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg1B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg1C.render(stack, builder, packedLight, packedOverlay, color);
        this.leg2A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg2B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg2C.render(stack, builder, packedLight, packedOverlay, color);
        this.leg3A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg3B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg3C.render(stack, builder, packedLight, packedOverlay, color);
        this.leg4A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg4B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg4C.render(stack, builder, packedLight, packedOverlay, color);
        this.leg5A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg5B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg5C.render(stack, builder, packedLight, packedOverlay, color);
        this.leg6A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg6B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg6C.render(stack, builder, packedLight, packedOverlay, color);
        this.leg7A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg7B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg7C.render(stack, builder, packedLight, packedOverlay, color);
        this.leg8A.render(stack, builder, packedLight, packedOverlay, color);
        this.leg8B.render(stack, builder, packedLight, packedOverlay, color);
        this.leg8C.render(stack, builder, packedLight, packedOverlay, color);

        if (babies && isAdult) {
            this.baby1.render(stack, builder, packedLight, packedOverlay, color);
            this.baby2.render(stack, builder, packedLight, packedOverlay, color);
            this.baby3.render(stack, builder, packedLight, packedOverlay, color);
            this.baby4.render(stack, builder, packedLight, packedOverlay, color);
            this.baby5.render(stack, builder, packedLight, packedOverlay, color);
        }
    }
