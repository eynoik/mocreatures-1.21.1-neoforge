...
public class MoCModelDuck<T extends MoCEntityDuck> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "duck"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight,
        ...
        this.bill.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.chin.render(poseStack, buffer, packedLight, packedOverlay, color);
