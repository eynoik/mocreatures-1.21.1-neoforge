...
public class MoCModelElephant<T extends MoCEntityElephant> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "elephant"), "main"
    );
    ...
    public void renderToBuffer(PoseStack matrixStack, VertexConsumer buffer, int packedLight, int packedOverlay,
        ...
        if (tusks == 0) {
            leftTuskB.render(matrixStack, buffer, packedLight, packedOverlay, color);
            rightTuskB.render(matrixStack, buffer, packedLight, packedOverlay, color);
            if (elephant.getIsAdult() || elephant.getMoCAge() > 70) {
                leftTuskC.render(matrixStack, buffer, packedLight, packedOverlay, color);
                rightTuskC.render(matrixStack, buffer, packedLight, packedOverlay, color);
            }
            if (elephant.getIsAdult() || elephant.getMoCAge() > 90) {
                leftTuskD.render(matrixStack, buffer, packedLight, packedOverlay, color);
                rightTuskD.render(matrixStack, buffer, packedLight, packedOverlay, color);
            }
        } else if (tusks == 1) {
            tuskLW1.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLW2.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLW3.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLW4.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLW5.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRW1.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRW2.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRW3.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRW4.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRW5.render(matrixStack, buffer, packedLight, packedOverlay, color);
        } else if (tusks == 2) {
            tuskLI1.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLI2.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLI3.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLI4.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLI5.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRI1.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRI2.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRI3.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRI4.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRI5.render(matrixStack, buffer, packedLight, packedOverlay, color);
        } else if (tusks == 3) {
            tuskLD1.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLD2.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLD3.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLD4.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskLD5.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRD1.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRD2.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRD3.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRD4.render(matrixStack, buffer, packedLight, packedOverlay, color);
            tuskRD5.render(matrixStack, buffer, packedLight, packedOverlay, color);
        }

        // ears: big if African (type=1), small otherwise
        if (type == 1) {
            leftBigEar.render(matrixStack, buffer, packedLight, packedOverlay, color);
            rightBigEar.render(matrixStack, buffer, packedLight, packedOverlay, color);
        } else {
            leftSmallEar.render(matrixStack, buffer, packedLight, packedOverlay, color);
            rightSmallEar.render(matrixStack, buffer, packedLight, packedOverlay, color);
        }

        // mammoths (type 3 or 4)
        if (type == 3 || type == 4) {
            headBump.render(matrixStack, buffer, packedLight, packedOverlay, color);
            skirt.render(matrixStack, buffer, packedLight, packedOverlay, color);
        }

        // harness
        if (harness >= 1) {
            harnessBlanket.render(matrixStack, buffer, packedLight, packedOverlay, color);
            harnessUpperBelt.render(matrixStack, buffer, packedLight, packedOverlay, color);
            harnessLowerBelt.render(matrixStack, buffer, packedLight, packedOverlay, color);
            if (type == 5) {
                skirt.render(matrixStack, buffer, packedLight, packedOverlay, color);
            }
        }
        ...
        if (harness == 3) {
            if (type == 5) {
                cabinPillow.render(matrixStack, buffer, packedLight, packedOverlay, color);
                cabinLeftRail.render(matrixStack, buffer, packedLight, packedOverlay, color);
                cabin.render(matrixStack, buffer, packedLight, packedOverlay, color);
                cabinRightRail.render(matrixStack, buffer, packedLight, packedOverlay, color);
                cabinBackRail.render(matrixStack, buffer, packedLight, packedOverlay, color);
                cabinRoof.render(matrixStack, buffer, packedLight, packedOverlay, color);
            }
            if (type == 4) {
                fortBackRightWall.render(matrixStack, buffer, packedLight, packedOverlay, color);
                fortBackLeftWall.render(matrixStack, buffer, packedLight, packedOverlay, color);
                fortBackWall.render(matrixStack, buffer, packedLight, packedOverlay, color);
                fortFloor1.render(matrixStack, buffer, packedLight, packedOverlay, color);
                fortFloor2.render(matrixStack, buffer, packedLight, packedOverlay, color);
                fortFloor3.render(matrixStack, buffer, packedLight, packedOverlay, color);
                fortNeckBeam.render(matrixStack, buffer, packedLight, packedOverlay, color);
                fortBackBeam.render(matrixStack, buffer, packedLight, packedOverlay, color);
            }
        }

        // storage chests + blankets
        if (storage >= 1) {
            storageRightBedroll.render(matrixStack, buffer, packedLight, packedOverlay, color);
            storageFrontRightChest.render(matrixStack, buffer, packedLight, packedOverlay, color);
            storageBackRightChest.render(matrixStack, buffer, packedLight, packedOverlay, color);
            storageRightBlankets.render(matrixStack, buffer, packedLight, packedOverlay, color);
        }
        if (storage >= 2) {
            storageLeftBlankets.render(matrixStack, buffer, packedLight, packedOverlay, color);
            storageLeftBedroll.render(matrixStack, buffer, packedLight, packedOverlay, color);
            storageFrontLeftChest.render(matrixStack, buffer, packedLight, packedOverlay, color);
            storageBackLeftChest.render(matrixStack, buffer, packedLight, packedOverlay, color);
        }
        if (storage >= 3) {
            storageUpLeft.render(matrixStack, buffer, packedLight, packedOverlay, color);
        }
        if (storage >= 4) {
            storageUpRight.render(matrixStack, buffer, packedLight, packedOverlay, color);
        }

        // HEAD, NECK, CHIN, LOWER LIP, BACK, HUMP, BODY
        head.render(matrixStack, buffer, packedLight, packedOverlay, color);
        neck.render(matrixStack, buffer, packedLight, packedOverlay, color);
        chin.render(matrixStack, buffer, packedLight, packedOverlay, color);
        lowerLip.render(matrixStack, buffer, packedLight, packedOverlay, color);
        back.render(matrixStack, buffer, packedLight, packedOverlay, color);
        hump.render(matrixStack, buffer, packedLight, packedOverlay, color);
        body.render(matrixStack, buffer, packedLight, packedOverlay, color);

        // TUSK A (always shown)
        rightTuskA.render(matrixStack, buffer, packedLight, packedOverlay, color);
        leftTuskA.render(matrixStack, buffer, packedLight, packedOverlay, color);

        // TRUNK segments
        trunkA.render(matrixStack, buffer, packedLight, packedOverlay, color);
        trunkB.render(matrixStack, buffer, packedLight, packedOverlay, color);
        trunkC.render(matrixStack, buffer, packedLight, packedOverlay, color);
        trunkD.render(matrixStack, buffer, packedLight, packedOverlay, color);
        trunkE.render(matrixStack, buffer, packedLight, packedOverlay, color);

        // LEGS
        frontRightUpperLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);
        frontRightLowerLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);
        frontLeftUpperLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);
        frontLeftLowerLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);
        backRightUpperLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);
        backRightLowerLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);
        backLeftUpperLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);
        backLeftLowerLeg.render(matrixStack, buffer, packedLight, packedOverlay, color);

        // TAIL
        tailRoot.render(matrixStack, buffer, packedLight, packedOverlay, color);
        tail.render(matrixStack, buffer, packedLight, packedOverlay, color);
        tailPlush.render(matrixStack, buffer, packedLight, packedOverlay, color);
    }
