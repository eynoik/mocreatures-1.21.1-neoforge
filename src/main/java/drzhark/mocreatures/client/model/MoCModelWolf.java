...
public class MoCModelWolf<T extends MoCEntityWWolf> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "wolf"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer,
        ...
        this.Nose2.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.LSide.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RSide.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.Nose.render(poseStack, buffer, packedLight, packedOverlay, color);

        if (this.openMouth) {
            this.MouthOpen.render(poseStack, buffer, packedLight, packedOverlay, color);
            this.UTeeth.render(poseStack, buffer, packedLight, packedOverlay, color);
            this.LTeeth.render(poseStack, buffer, packedLight, packedOverlay, color);
        } else {
            this.Mouth.render(poseStack, buffer, packedLight, packedOverlay, color);
            this.MouthB.render(poseStack, buffer, packedLight, packedOverlay, color);
        }
        ...
        this.Leg4D.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.Leg3D.render(poseStack, buffer, packedLight, packedOverlay, color);
