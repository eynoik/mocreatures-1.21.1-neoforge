...
public class MoCModelSmallFish<T extends MoCEntitySmallFish> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "small_fish"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.bodyFlat.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.bodyRomboid.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.midBodyFin.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.upperFinA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.upperFinB.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.upperFinC.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.lowerFinA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.lowerFinB.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.lowerFinC.render(poseStack, buffer, packedLight, packedOverlay, color);
