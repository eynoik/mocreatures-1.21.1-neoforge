...
public class MoCModelDeer<T extends MoCEntityDeer> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "deer"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight,
        ...
        this.LeftAntler.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RightAntler.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
}
