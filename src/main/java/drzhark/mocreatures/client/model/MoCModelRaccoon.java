...
public class MoCModelRaccoon<T extends MoCEntityRaccoon> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "raccoon"),
            "main"
    );
    ...
    public void renderToBuffer(PoseStack matrixStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        snout.render(matrixStack, buffer, packedLight, packedOverlay, color);
        rightEar.render(matrixStack, buffer, packedLight, packedOverlay, color);
        leftEar.render(matrixStack, buffer, packedLight, packedOverlay, color);
        ...
        tailA.render(matrixStack, buffer, packedLight, packedOverlay, color);
        tailB.render(matrixStack, buffer, packedLight, packedOverlay, color);

        rightFrontLegA.render(matrixStack, buffer, packedLight, packedOverlay, color);
        rightFrontLegB.render(matrixStack, buffer, packedLight, packedOverlay, color);
        rightFrontFoot.render(matrixStack, buffer, packedLight, packedOverlay, color);

        leftFrontLegA.render(matrixStack, buffer, packedLight, packedOverlay, color);
        leftFrontLegB.render(matrixStack, buffer, packedLight, packedOverlay, color);
        leftFrontFoot.render(matrixStack, buffer, packedLight, packedOverlay, color);

        rightRearLegA.render(matrixStack, buffer, packedLight, packedOverlay, color);
        rightRearLegB.render(matrixStack, buffer, packedLight, packedOverlay, color);
        rightRearFoot.render(matrixStack, buffer, packedLight, packedOverlay, color);

        leftRearLegA.render(matrixStack, buffer, packedLight, packedOverlay, color);
        leftRearLegB.render(matrixStack, buffer, packedLight, packedOverlay, color);
        leftRearFoot.render(matrixStack, buffer, packedLight, packedOverlay, color);
    }
