...
public class MoCModelEgg<T extends MoCEntityEgg> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "egg"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer,
                               ...
                               int color) {
        egg1.render(poseStack, buffer, packedLight, packedOverlay, color);
        egg2.render(poseStack, buffer, packedLight, packedOverlay, color);
        egg3.render(poseStack, buffer, packedLight, packedOverlay, color);
        egg4.render(poseStack, buffer, packedLight, packedOverlay, color);
        egg5.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
}
