...
public class MoCModelBird<T extends MoCEntityBird> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mocreatures", "bird"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay,
        ...
        beak.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        rWing.render(poseStack, buffer, packedLight, packedOverlay, color);
        lWing.render(poseStack, buffer, packedLight, packedOverlay, color);
