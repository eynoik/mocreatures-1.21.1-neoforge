...
public class MoCModelRat<T extends MoCEntityRat> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "rat"),
            "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        earR.render(poseStack, buffer, packedLight, packedOverlay, color);
        earL.render(poseStack, buffer, packedLight, packedOverlay, color);
        whiskerR.render(poseStack, buffer, packedLight, packedOverlay, color);
        whiskerL.render(poseStack, buffer, packedLight, packedOverlay, color);
        body.render(poseStack, buffer, packedLight, packedOverlay, color);
        tail.render(poseStack, buffer, packedLight, packedOverlay, color);
        frontL.render(poseStack, buffer, packedLight, packedOverlay, color);
        frontR.render(poseStack, buffer, packedLight, packedOverlay, color);
        rearL.render(poseStack, buffer, packedLight, packedOverlay, color);
        rearR.render(poseStack, buffer, packedLight, packedOverlay, color);
        bodyF.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
