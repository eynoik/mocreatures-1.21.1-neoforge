...
public class MoCModelSilverSkeleton<T extends MoCEntitySilverSkeleton> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "silver_skeleton"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.rightHand.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.rightSwordA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.rightSwordB.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.rightSwordC.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftArm.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftHand.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftSwordA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftSwordB.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftSwordC.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.rightThigh.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.rightKnee.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftThigh.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftKnee.render(poseStack, buffer, packedLight, packedOverlay, color);
        poseStack.popPose();
    }
}
