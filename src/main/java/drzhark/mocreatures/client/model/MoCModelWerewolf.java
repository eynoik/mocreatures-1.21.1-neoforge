...
public class MoCModelWerewolf<T extends MoCEntityWerewolf> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "werewolf"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay,
        ...
        this.TeethU.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethL.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.SideburnL.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SideburnR.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.RArmA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RArmB.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RArmC.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RHand.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LArmA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LArmB.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LArmC.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LHand.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RFinger1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RFinger2.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RFinger3.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RFinger4.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RFinger5.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LFinger1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LFinger2.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LFinger3.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LFinger4.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LFinger5.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
