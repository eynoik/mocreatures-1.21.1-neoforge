...
public class MoCModelBunny<T extends MoCEntityBunny> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mocreatures", "bunny"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer,
                               ...
                               int color) {
        part1.render(poseStack, buffer, packedLight, packedOverlay, color);
        part8.render(poseStack, buffer, packedLight, packedOverlay, color);
        part9.render(poseStack, buffer, packedLight, packedOverlay, color);
        part10.render(poseStack, buffer, packedLight, packedOverlay, color);
        part11.render(poseStack, buffer, packedLight, packedOverlay, color);
        part2.render(poseStack, buffer, packedLight, packedOverlay, color);
        part3.render(poseStack, buffer, packedLight, packedOverlay, color);
        part4.render(poseStack, buffer, packedLight, packedOverlay, color);
        part5.render(poseStack, buffer, packedLight, packedOverlay, color);
        part6.render(poseStack, buffer, packedLight, packedOverlay, color);
        part7.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
