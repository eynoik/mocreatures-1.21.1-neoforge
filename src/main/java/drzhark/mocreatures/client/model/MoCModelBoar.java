...
public class MoCModelBoar<T extends MoCEntityBoar> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mocreatures", "boar"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay,
        ...
        trout.render(poseStack, buffer, packedLight, packedOverlay, color);
        tusks.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        headMane.render(poseStack, buffer, packedLight, packedOverlay, color);
        body.render(poseStack, buffer, packedLight, packedOverlay, color);
        bodyMane.render(poseStack, buffer, packedLight, packedOverlay, color);
        tail.render(poseStack, buffer, packedLight, packedOverlay, color);
        upperLegRight.render(poseStack, buffer, packedLight, packedOverlay, color);
        lowerLegRight.render(poseStack, buffer, packedLight, packedOverlay, color);
        upperLegLeft.render(poseStack, buffer, packedLight, packedOverlay, color);
        lowerLegLeft.render(poseStack, buffer, packedLight, packedOverlay, color);
        upperHindLegRight.render(poseStack, buffer, packedLight, packedOverlay, color);
        lowerHindLegRight.render(poseStack, buffer, packedLight, packedOverlay, color);
        upperHindLegLeft.render(poseStack, buffer, packedLight, packedOverlay, color);
        lowerHindLegLeft.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
